        ...
        <div className="flex h-full flex-col items-center justify-center">
            <Card className="h-fit w-[450px] space-y-4">
                <div className="flex flex-row items-center justify-between gap-2">
                    ...
                    <div className="flex flex-col items-center justify-center gap-1 rounded border border-gray-400 px-1 py-1.5">
                        <div className="text-[12px] leading-1.5 font-semibold text-gray-500 uppercase">Multi</div>
                        <div className="text-[10px] leading-1.5 text-gray-500 uppercase">select</div>
                    </div>
                </div>
