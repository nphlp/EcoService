...
export default async function Page() {
    ...
    const articleManyFetch = await Fetch({ route: "/internal/article/findMany", params: paramsMany });
    ...
    const articleFirstFetch = await Fetch({ route: "/internal/article/findFirst", params: paramsFirst });
    ...
    const articleUniqueFetch = await Fetch({ route: "/internal/article/findUnique", params: paramsUnique });
    ...
    const articleCountFetch = await Fetch({ route: "/internal/article/count", params: paramsCount });
