...
import { QueryParamType, queryParamCached } from "./components/useCatalogueParams";
import { CatalogueStoreProvider } from "./components/useCatalogueStore";
    ...
    return (
        <div className="flex flex-1 flex-col">
            ...
            <div className="flex flex-1 flex-col justify-start gap-4 overflow-hidden">
                <CatalogueStoreProvider initialState={{ productList, productAmount }}>
