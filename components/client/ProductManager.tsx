...
import { Button, Input, TextArea, Label } from "react-aria-components";
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="mx-auto max-w-7xl px-4 py-16">
                ...
                <div className="mb-12 flex items-center justify-between">
                    ...
                    <button className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-4 py-2 text-gray-700 shadow-sm transition-all hover:shadow-md">
                    ...
                    <div className="grid grid-cols-1 gap-16 md:grid-cols-3">
                        <div>
                            ...
                            <p className="text-gray-300">
                                Notre mission est de faciliter l&apos;accès aux services écologiques pour un avenir plus durable.
                            </p>
                        </div>
                        <div>
                            <h3 className="mb-6 text-2xl font-bold text-[#5CEBDF]">
