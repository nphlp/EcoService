        ...
        try {
            ...
            if (!response.ok) {
                if (data.error?.includes("account has been rejected")) {
                    throw new Error("Le service n'est pas encore disponible. Veuillez réessayer plus tard.");
                }
        ...
        <div className="text-center">
            ...
            <div className="space-y-4">
                ...
                <p className="text-gray-600">
                    Configurez votre compte vendeur pour commencer à vendre sur notre plateforme.
                </p>
                {error?.includes("pas encore disponible") ? (
                    <p className="text-sm text-amber-600">
                        Notre service d&apos;inscription des vendeurs est en cours de configuration. Merci de votre
                        patience.
                    </p>
                ) : (
