...
const getContentCached = cache(
    async (stringParams: string): Promise<ResponseFormat<FindUniqueContentResponse>> => {
 ...
 */
export const GET = async (request: NextRequest): Promise<NextResponse<ResponseFormat<FindUniqueContentResponse>>> => {
    try {
