...
export const AddressFindFirstApi = async <T extends Prisma.AddressFindFirstArgs>(
    ...
    try {
        const params: AddressFindFirstProps<T> = decodeParams(request.nextUrl.searchParams);
...
export const AddressFindUniqueApi = async <T extends Prisma.AddressFindUniqueArgs>(
    ...
    try {
        const params: AddressFindUniqueProps<T> = decodeParams(request.nextUrl.searchParams);
...
export const AddressFindManyApi = async <T extends Prisma.AddressFindManyArgs>(
    ...
    try {
        const params: AddressFindManyProps<T> = decodeParams(request.nextUrl.searchParams);
...
export const AddressCountApi = async <T extends Prisma.AddressCountArgs>(
    ...
    try {
        const params: AddressCountProps<T> = decodeParams(request.nextUrl.searchParams);
