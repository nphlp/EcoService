...
const getDoItYourselfListCached = cache(
    async (stringParams: string): Promise<ResponseFormat<FindManyDoItYourselfResponse>> => {
 ...
 */
export const GET = async (request: NextRequest): Promise<NextResponse<ResponseFormat<FindManyDoItYourselfResponse>>> => {
    try {
