...
export const productData: Prisma.ProductCreateInput[] = [
    // Fruits & Légumes
    {
        ...
        image: "/illustration/3W-CTJ7Yz7w.webp",
        price: 25.99,
        stock: 50,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/3g7YZVUV0A0.webp",
        price: 18.5,
        stock: 40,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/66OgXiZ-pWk.webp",
        price: 4.99,
        stock: 30,
        Category: {
            connect: {
    ...
    // Produits Laitiers
    {
        ...
        image: "/illustration/7xcn6e8vixk.webp",
        price: 7.99,
        stock: 25,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/835ZNqIYAn8.webp",
        price: 4.5,
        stock: 60,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/8wBP80yThLU.webp",
        price: 3.99,
        stock: 45,
        Category: {
            connect: {
    ...
    // Boulangerie
    {
        ...
        image: "/illustration/AB-HJwWN6Zk.webp",
        price: 4.5,
        stock: 30,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/AcSjR6BmyqE.webp",
        price: 6.99,
        stock: 40,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/AuhPy2NofM0.webp",
        price: 1.5,
        stock: 100,
        Category: {
            connect: {
    ...
    // Viandes & Poissons
    {
        ...
        image: "/illustration/B2tKxL9KVqA.webp",
        price: 32.99,
        stock: 20,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/BRVqq2uak4E.webp",
        price: 24.99,
        stock: 25,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/BZg6FvH1NO0.webp",
        price: 15.99,
        stock: 30,
        Category: {
            connect: {
    ...
    // Épicerie
    {
        ...
        image: "/illustration/BgbcekiNBlo.webp",
        price: 12.99,
        stock: 40,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/DVfqws3bRxE.webp",
        price: 8.5,
        stock: 35,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/EvP4FOhMniM.webp",
        price: 5.99,
        stock: 50,
        Category: {
            connect: {
    ...
    // Hygiène & Beauté
    {
        ...
        image: "/illustration/IbfC88l5u8c.webp",
        price: 5.99,
        stock: 55,
        Category: {
            connect: {
    ...
    // Maison & Entretien
    {
        ...
        image: "/illustration/J9_a3-O7vGs.webp",
        price: 12.99,
        stock: 45,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/JHpAm3IQg5Q.webp",
        price: 6.99,
        stock: 60,
        Category: {
            connect: {
    ...
    },
    {
        ...
        image: "/illustration/KRkn9QXpd8I.webp",
        price: 4.99,
        stock: 50,
        Category: {
            connect: {
